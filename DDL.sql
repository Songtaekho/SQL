...
CREATE TABLE DEPTS (
    ...
    DEPT_CONTENT LONG -- 최대 2기가 가변문자열 (VARCHAR2 보다 더 큰 문자열) 많이 사용 X
);

DESC DEPTS;

INSERT INTO DEPTS VALUES(99, 'HELLO', 'Y', SYSDATE, 3.14, 'HELLO WORLD~~~~~ BYE');
INSERT INTO DEPTS VALUES(100, 'HELLO', 'N', SYSDATE, 3.14, 'HELLO WORLD'); -- DEFT_NO 초과
INSERT INTO DEPTS VALUES(10, 'HELLO', '가', SYSDATE, 3.14, 'HELLO'); -- DEFT_YN 초과
SELECT * FROM DEPTS;
--------------------------------------------------------------------------------
--컬럼 추가 ADD
...
INSERT INTO DEPT2 VALUES(999, 'HELLO', '1234', 'M', SYSDATE, 3.14159);
