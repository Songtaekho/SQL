...
SELECT DEPTS_SEQ.NEXTVAL FROM DUAL; -- 한번 NEWXVAL가 일어나면 후진은 불가능
...
ALTER SEQUENCE DEPTS_SEQ INCREMENT BY -20 MINVALUE 0; 
--전진을 시킴
...
--고유인덱스는(PK, UK)를 만들때 자동으로 생성되는 인덱스 입니다.
...
--고유인덱스
CREATE UNIQUE INDEX 인덱스명 ON 테이블명(부착할컬럼); -- PK, UK 만들때 자동 생성해줍니다(PK, UK 조회할 때 인덱스 효과를 받음)
