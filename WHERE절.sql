...
SELECT * FROM EMPLOYEES WHERE FIRST_NAME LIKE '_ar%'; -- _는 자리 수
SELECT * FROM EMPLOYEES WHERE HIRE_DATE LIKE '___05%'; 

-- IS NULL, IS NOT NULL
SELECT * FROM EMPLOYEES WHERE COMMISSION_PCT = NULL; -- X IS NULL로 써야함
...
SELECT FIRST_NAME, SALARY * 12 AS 연봉 FROM EMPLOYEES WHERE 연봉 >= 10000; -- WHERE에서는 안됨
